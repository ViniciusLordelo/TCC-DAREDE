    ...
    public class FunilariaContext : DbContext
        {
            ...
            //Vinicius
           //Data Source = DESKTOP - 2PS01IL; Initial Catalog = FunilariaDEV; user id = sa; pwd = vinilordelo1

            //Enzzo 
             optionsBuilder.UseSqlServer("Data Source=DESKTOP-2PS01IL; Initial Catalog = FunilariaDEV; user id=sa; pwd=vinilordelo1");
